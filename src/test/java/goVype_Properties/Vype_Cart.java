...
public class Vype_Cart {
	...
	public static By edtDiscountCode = By.xpath(".//input[@name='discountCode']");
   ...
   //adding discount
	...
	public static By weTxtTotal=By.xpath("//*[contains(text(),'One time purchase total')]/../strong");
	...
	//Added by Sandeepa
		...
		public static By weTxtVypePlus=By.xpath("(.//*[@class='Incentive__StyledPlusLogo-sc-1gtskae-6 lptQfH u-hide-medium-down'])");
		...
		public static By weTxtHeySilverMember=By.xpath("(.//*[@class='Incentive__Disclaimer-sc-1gtskae-5 pIIwz'])");
		
		//Text show how you will benefit" link is present at the top right in the HTML Frame.
		public static By weTxtSeeHowYouBenefit=By.xpath("(.//*[contains(text(),'See how you will benefit')])[2]");
		
		//Pop dispalyed with below information "gold,free shipping on all orders,birthday gift
		public static By weTxtPopupDisplayedGold=By.xpath("(.//*[@class='Incentive__DropdownTitle-sc-1gtskae-11 dEZick'])[2]");
				// "(.//*[@class='Incentive__DropdownContainer-sc-1gtskae-9 dogkzU'])[2]");

		//pop up "x"(close pop up)
		public static By lnkPopupClose=By.xpath("(//*[@class='Icon__Container-sc-1st5y7f-0 dSqsPg'])[6]");
				// "(.//*[@icon='close-small'])[2]");
		...
		//public static By weTxtYouAreAlmostSilverStatus=By.xpath("(.//*[@class='Incentive__Tier-sc-1gtskae-3 epWSyy'])");
		...
		//Updated by Vinod on Sep 22, 2021
		
		//Button CheckOut
		//public static By btnCheckOut=By.xpath("//*[text()='Cart summary']/following::button[1]");
