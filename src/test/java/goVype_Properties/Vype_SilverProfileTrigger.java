...
/*		public static boolean VerifyMultipleCartValueInAMonthAsPerTestCaseThreeCondition(int TotalNumberOfOrdersInAMonth){
   ...
   //Silver status
    public static By labelYourStatus=By.xpath("(//*[contains(@class,'Tier__TierWrapper')])[2]");
    ...
    //Date text field
    public static By textDate=By.xpath("(.//*[text()='Date: '])[1]");
    ...
    public static By toggleButton=By.xpath("(.//*[@class='Toggle__Indicator-sc-1te86bk-2 icWPpS'])[1]");
