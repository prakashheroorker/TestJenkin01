...
public class Vype_Footer {
	...
	public static By BadgeBirthday = By.xpath("//*[contains(@class,'Badge__Wrapper-sc')]//*[@alt='Birthday icon']");

	public static By txtPurchase = By.xpath("(//*[contains(@class, 'ActivityTable__Row')]//*[text()='Purchase'])/..");//*[contains(@class, 'ActivityTable__Row-sc-11bo538-1 ActivityTable__ActivityRow')][2]");
	...
	//Terms & Conditions page displayed 
		...
		public static By pgTermsAndCondition=By.xpath("//*[text()='Terms and Conditions']");
}
