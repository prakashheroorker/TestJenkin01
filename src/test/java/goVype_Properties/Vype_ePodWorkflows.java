...
public class Vype_ePodWorkflows {
	...
	public static By txtFloatingMessage = By.xpath("(.//a[contains(@href,'/cart')])[1]");
	...
	//==================================ePodPods Page===================
	   ...
	   //Verify the"Mix & Match:5 pack Bundle" card with the image for $45.00  and text as "Select 5 packs of your choice and save 25%" with the "Create" button is displayed
		...
		public static By ImageDividedMixMatch=By.xpath("(.//*[contains(@class,'BuyChrome__Background-sc')])");
	 ...
	 //flavour modal - Blood Orange
	   ...
	   public static By btnNicotineplus=By.xpath("(//*[@class='Icon__Container-sc-1st5y7f-0 dSqsPg'])[22]");
	...
	// At the right side bottom of the page "Add one more pack" button is in disabled state.
	 ...
	 //Vuse limited Edition
	   ...
	   /* Added by Harika for BDD development */
		public static By btnaddchargingcable=By.xpath("//*[contains(text(),'Charging Cable')]/../../following-sibling::footer/div[1]/button[2]");


		//Updated by Harsha in October Month for BDD Development
		
		//oct 18
		public static By txtrightimgmultipack2=By.xpath("//*[text()='Mix & Match: 2 Pack Bundle']/../..");

		public static By txtHeaderMixAndMatch2PackBundle=By.xpath("//*[contains(text(),'Select 2 packs of ')]");


		//oct 26
		public static By txtrightimgmultipack5=By.xpath("//*[text()='Mix & Match: 5 Pack Bundle']/../..");

		public static By txtHeaderMixAndMatch5PackBundle=By.xpath("//*[contains(text(),'Select 5 packs of ')]");
