...
Feature: To verify product catalogue section
  ...
  @calalogue01 @GoldenRegressionSuite
  Scenario Outline: ePod2_ProductCatalogue_HeroSlide
    ...
    Examples: 
      | UN                 | pwd      | devicecolour |
      | ian.cabato@bat.com | TEST1234 | Blue  |
  ...
  @calalogue02 @GoldenRegressionSuite
  ...
  #Developed By - Harsha Kumar
  #Date - September 24,2021
  @calalogue03 @GoldenRegressionSuite
