...
public class Vype_ConditionsOfSale {
	...
	//a[contains(@href,'pages/conditions-of-sale/')]

	//ConditionsOfSale Page 
	public static By pgeConditionsOfSale=By.xpath(".//h1[text()='Conditions of Sale']");
	...
	public static By lnkTermsAndConditions=By.xpath(".//*[text()='Terms & Conditions']");//a[@href='https://govype.ca/pages/terms-conditions']
	
	//Terms And Conditions Page
	public static By pgeTermsAndConditions=By.xpath(".//h1[text()='Terms & Conditions']");
	
	//Contact Us Link
	public static By lnkContactUs=By.xpath("(.//*[text()='Contact Us'])[2]");//.//a[@href='https://govype.ca/contact-us']
	...
	public static By pgeContactUs = By.xpath("//*[text()='Get in touch']/../../../../..");
