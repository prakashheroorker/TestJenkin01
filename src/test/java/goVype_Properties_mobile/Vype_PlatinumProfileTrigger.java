...
public class Vype_PlatinumProfileTrigger {
	...
	public static final By PriceVal = By.xpath("(//*[text()='13.00'])[1]");
	...
	public static By weErrorMsgPasswordField = By.xpath("//*[text()='Password is required']");
		...
		//Rewards Page
		public static By pgRewards = By.xpath("(.//a[@href='/ca/en/account/rewards/'])//*[text()='Rewards']");
				// "(.//*[text()='Rewards'])");
		...
		//Platinum Befinits
		public static By platniumbenfits =By.xpath(".//*[contains(@class,'TierBenefits__Content')]");
		...
		public static By btnUSBChargingCable = By.xpath("//*[text()='Magnetic USB Charging Cable']");
		...
		public static By itemsinCart = By.xpath(".//div[@class='Product__Container-ra1xzv-0 gdvpfL']");
		...
		//Platinum Card
		public static By wePlatinumCard = By.xpath(".//*[contains(@class,'TierCard')]//span[text()='platinum']");
				// ".//*[@class='TierProfileHeader__CardWrap-sc-1q6fxmg-4 iUGXuW']");
		
		public static By discounts =By.xpath("//*[contains(text(),'Hi')]/../../../../div[2]");
		
		//Platinum Benefits
		public static By txtBenifits = By.xpath("//*[contains(text(),'Your benefits')]/..");
		...
		public static By txtPlatinumBenifitsPoints = By.xpath(".//div[@class='TierBenefits__Content-sc-1bk8881-3 ljjUBJ']");
		...
		//EPods Advisory Text
		public static By txtAdvisoryEPodsPods = By.xpath("//*[@class='CollectionHeader__Description-sc-1no8wao-3 ivqVuD']"); // xpath chnanged in same UI
		...
		public static By txtLegalAdvisoryHeadQuarters = By.xpath("(.//p[@class='Footer__Disclaimer-sc-1uvvy50-6 kzykla'])[2]");
		...
		//EPod Pods Flavour
		public static By weEPodPodsFlavour = By.xpath("//*[@class='CartridgeThumbnail__Name-m1q1va-5 dHljUc']");//div[@class='CartridgeList__Inner-sc-9th72d-1 dpXSqR']
		...
		public static By weTotalAmountInCucumberFlavour = By.xpath(".//*[@class='typography__H3-sc-10lefml-2 Summary__Price-sc-1hujf0n-5 exunCV dvERNO']");
		...
		public static By btnCloseRegistrationPage = By.xpath("(.//*[@class='Modal__Close-sc-1nnlwcp-4 faFQBL'])[2]");
				// "(.//*[@icon='close-small'])[2]");
	...
	//******************************	
		...
		public static By lnkShowOrderSummary= By.xpath("//*[text()='Show order summary']");
